...
\begin{figure*}
\begin{center}
\includegraphics[width=0.5\linewidth]{gaussian_base.pdf}
\end{center}
...
The time derivative of the interpolant $I$ provides a ``flow-matching'' objective, which is saturated when the norm of the velocity field 
\begin{equation}
    \mathcal{L}_{\rm FM} = \EE_{t} \EE_{\xb_0, \xb_1, \zb} \left( \frac12 |v_\theta(\xb, t)|^2 - \dot I(\xb_0, \xb_1) \cdot v_{\theta}(\xb, t) \right).
\end{equation}
